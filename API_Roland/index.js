...
app.post("/api/payment/create", authMiddleware, createPayPalOrder);
app.post("/api/payment/capture", authMiddleware, capturePayPalOrder);
app.get("/api/payment/order/:orderId", authMiddleware, getOrderStatus);
